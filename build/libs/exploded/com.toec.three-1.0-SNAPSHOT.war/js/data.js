    ...
    var Aobjects = {
        objects: [
            ...
            },
            {
                ...
                copyfrom: 'cabinet1_1',
                name: 'cabinet'+1+'_'+2,
                childrenname: ['cabinet' + 1 + '_' + 2 + '_shell', 'cabinet' + 1 + '_' + 2 + '_door_01'],
                uuid: '',
                objType: 'cloneObj',
                position: { x:-(1-1)*200, y:0 , z:(2-1)*100 },
                scale: { x: 1, y: 1, z: 1 },
                ip:'ip2'
        ...
        btns: [
            ...
            },
            {
                ...
                event: function () {
                  /*msjstation.addTestObj();
				  var a={
					  show1:'111a'
				  }
				  alert(a.show1)
				  */
				  //_tempObj = msjstation.createCube(msjstation, _obj);
                  //msjstation.addObject(_tempObj);
				var cab=  {
                    show: true,
                    copyfrom: 'cabinet1_1',
                    name: 'cabinet4_4',
                    childrenname: ['cabinet4_4_shell', 'cabinet4_4_door_01'],
                    uuid: '',
                    objType: 'cloneObj',
                    position: { x:-(4-1)*200, y:0 , z:(4-1)*100 },
                    scale: { x: 1, y: 1, z: 1 }
                 }
            ...
            },
            {
                ...
                event: function () {
                    msjstation.deleteObject('cabinet4_4');
                }
            },
            {
                btnid: "btn_edit",
